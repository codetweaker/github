...
define('TITLE', 'SX3 | Distributors | SX3 products  ');
define('DESCRIPTION','SX3 Distributors ');
define('KEYWORDS','SX3 products, distributors, vancouver, beauty supply, hair, flat irons');
   ...
   <div class="container">   
      ...
      <div class="row">  
         <div class="span8"> 
             ...
             <h3>
                 Please contact us for information regarding exclusive wholesale distribution in your market
             </h3>
               <?php
